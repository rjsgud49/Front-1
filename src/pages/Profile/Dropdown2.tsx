      ...
      <div className="relative">
        <div className="w-full h-32 overflow-hidden rounded-t-lg">
          <img
            src=""
            alt="banner"
            className="block object-cover w-full h-full bg-gray-400"
          />
        </div>
        <Link
          to="/profile"
        ...
        >
          <img
            ...
            alt="avatar"
            className="absolute object-cover w-20 h-20 transform -translate-x-1/2 -translate-y-1/2 border-4 border-white rounded-full left-1/2 top-32"
          />
        </Link>
      </div>
