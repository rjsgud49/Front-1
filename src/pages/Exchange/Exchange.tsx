export default function Exchange() {
  return (
    <>
      ...
      {/* 카드 리스트 */}
      <div className="max-w-[1500px] mx-auto mt-10 grid grid-cols-3 gap-8 px-4 p-25">
        {/* 간식 구매 페이지 카드 */}
        <div className="p-6 transition bg-white shadow-md cursor-pointer rounded-2xl hover:shadow-lg">
